...
public class TwitterFriendsViewModel extends BaseViewModel<TwitterFriendsNavigator, FragmentTwitterFriendsBinding> implements ItemClickWithType<ProductOwner> {
    ...
    public <V extends ViewDataBinding, N extends BaseNavigator> TwitterFriendsViewModel(Context mContext, DataManager dataManager, V viewDataBinding, N navigation) {
        super(mContext, dataManager, (TwitterFriendsNavigator) navigation, (FragmentTwitterFriendsBinding) viewDataBinding);
    }
    ...
    public void getData() {
        ...
        getDataManager().getAccountService().getTwitterFriends(getMyContext(), enableLoading, isRefreshing ? 0 :
