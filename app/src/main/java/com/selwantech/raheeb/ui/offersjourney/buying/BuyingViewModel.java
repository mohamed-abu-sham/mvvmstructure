...
public class BuyingViewModel extends BaseViewModel<BuyingNavigator, FragmentBuyingBinding> implements RecyclerClick<Product> {
    ...
    public <V extends ViewDataBinding, N extends BaseNavigator> BuyingViewModel(Context mContext, DataManager dataManager, V viewDataBinding, N navigation) {
        super(mContext, dataManager, (BuyingNavigator) navigation, (FragmentBuyingBinding) viewDataBinding);
    }
    ...
    public void getData() {
        ...
        getDataManager().getProductService().getBuying(getMyContext(), enableLoading,
