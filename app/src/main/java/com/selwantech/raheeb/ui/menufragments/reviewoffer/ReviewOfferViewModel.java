...
public class ReviewOfferViewModel extends BaseViewModel<ReviewOfferNavigator, FragmentReviewOfferBinding> {
    ...
    protected void setUp() {
        ...
        getViewBinding().switchCash.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                buyNow.setShipping_method(isChecked ? "cach" : "");
    ...
    private boolean isValid() {
        ...
        if (buyNow.getShipping_method().isEmpty()) {
    ...
    private void setGooglePayDis() {
        ...
        description.append(" ");
        description.append(GeneralFunction.textColor(getMyContext().getResources().getString(R.string.terms_of_service), "#55ACEE"));
