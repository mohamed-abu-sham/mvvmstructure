...
import static com.selwantech.raheeb.utils.seekbar.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.selwantech.raheeb.utils.seekbar.SeekBar.INDICATOR_ALWAYS_SHOW;


public class ConditionSeekBar extends View {
    ...
    private ArrayList<Condition> tickMarkTextArray;
...
//            tickMarkTextArray = t.getTextArray(R.styleable.RangeSeekBar_rsb_tick_mark_text_array);
    ...
    public ArrayList<Condition> getTickMarkTextArray() {
        return tickMarkTextArray;
    }

    public void setTickMarkTextArray(ArrayList<Condition> tickMarkTextArray) {
