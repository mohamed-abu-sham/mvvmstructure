...
public class FollowersViewModel extends BaseViewModel<FollowersNavigator, FragmentFollowersBinding> implements ItemClickWithType<ProductOwner> {
    ...
    public <V extends ViewDataBinding, N extends BaseNavigator> FollowersViewModel(Context mContext, DataManager dataManager, V viewDataBinding, N navigation) {
        super(mContext, dataManager, (FollowersNavigator) navigation, (FragmentFollowersBinding) viewDataBinding);
    }
...
//                    getData();
    ...
    public void getData() {
        ...
        getDataManager().getAccountService().getFollowers(getMyContext(), enableLoading, isRefreshing ? 0 :
