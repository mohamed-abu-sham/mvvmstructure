...
public class ProductImageViewModel extends BaseObservable {
    ...
    public ProductImageViewModel(Context context, ImagesItem imagesItem, int position, RecyclerClick mRecyclerClick) {
