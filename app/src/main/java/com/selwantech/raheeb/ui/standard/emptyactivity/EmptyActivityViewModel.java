package com.selwantech.raheeb.ui.standard.emptyactivity;
...
public class EmptyActivityViewModel extends BaseViewModel<ActivityEmptyBinding> {


    private MutableLiveData<Boolean> isLoading;
    private MutableLiveData<List<DataExample>> dataExampleList;

    public <V extends ViewDataBinding> EmptyActivityViewModel(Context mContext, DataManager dataManager, V viewDataBinding, Intent intent) {
        super(mContext, dataManager, intent, (ActivityEmptyBinding) viewDataBinding);
